...
import { ClassifyPageClient } from '@/components/classify-page-client';
...
export default async function ClassifyPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold text-zinc-900 mb-2">Maturity Classification</h1>
      <p className="text-zinc-600 mb-8">
        Combines your Data Maturity Index and AI Maturity Score into a matrix position, classification label, risk, and opportunity.
      </p>
      <ClassifyPageClient organisationId={id} />
    </div>
  );
}
