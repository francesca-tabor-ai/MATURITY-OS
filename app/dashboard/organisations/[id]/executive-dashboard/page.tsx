...
export default async function ExecutiveDashboardPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold text-zinc-900 mb-2">Executive Dashboard</h1>
      <p className="text-zinc-600 mb-8">
        Unified view of maturity position, financial upside, risk exposure, and transformation roadmap.
      </p>
      <ExecutiveDashboard organisationId={id} />
    </div>
  );
}
